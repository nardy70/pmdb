$(document).ready(function () {
	$('#grid_statistichemese').datagrid({
		url:'data/statistiche/readStatisticheMese.cfm',
		rownumbers:false,
		fitColumns:true,
		striped:true,
	    columns:[[
	    	...
	    	{field:'fiche_servizi',title:'Fiche Servizi',align:'center',
	    		formatter: function(value){
	    			if (isNaN(value) || value === '' || value === null){
	    				return ('0,00');
	    			} else {
			...
			{field:'fiche_totale',title:'Fiche Totale',align:'center',
	    		formatter: function(value){
	    			if (isNaN(value) || value === '' || value === null){
	    				return ('0,00');
	    			} else {
			...
			{field:'percentuale_vendite',title:'Percentuale Vendite',align:'center',
				formatter: function(value){
	    			if (isNaN(value) || value === '' || value === null){
	    				...
	    				return (accounting.formatMoney(value, "", 1, ".", ",") + " \u0025");
	    			}	
	    		}
	    	},
